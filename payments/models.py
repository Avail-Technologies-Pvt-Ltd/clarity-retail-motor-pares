...
class PaymentMethod(models.Model):
	...
	zimra_money_type_text = models.CharField(max_length=10, blank=True, null=True, default="Cash")
...
class SaleTransaction(models.Model):
	...
	buyer_name = models.CharField(max_length=100, blank=True, null=True, default="")
	buyer_tin = models.CharField(max_length=100, blank=True, null=True, default="")
	buyer_vat = models.CharField(max_length=100, blank=True, null=True, default="")
	buyer_address = models.CharField(max_length=100, blank=True, null=True, default="")
	buyer_tel = models.CharField(max_length=100, blank=True, null=True, default="")
	buyer_email = models.CharField(max_length=100, blank=True, null=True, default="")
